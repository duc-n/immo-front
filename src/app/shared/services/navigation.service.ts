    ...
    defaultMenu: IMenuItem[] = [
        {
            ...
            sub: [
                ...
                { icon: 'i-Money', name: 'Générer une facture acquéreur', state: '/dashboard/v4', type: 'link' },
                { icon: 'i-Clock', name: 'Générer une facture consultant', state: '/dashboard/v4', type: 'link' },
        ...
        },
        {
            ...
            icon: 'i-Conference',
            sub: [
                { icon: 'i-Clock-3', name: 'Créer un acquéreur', state: '/dashboard/v1', type: 'link' },
                { icon: 'i-Data-Search', name: 'Rechercher un acquéreur', state: '/dashboard/v2', type: 'link' },
                { icon: 'i-Over-Time', name: 'Créer un mandat de recherche', state: '/dashboard/v3', type: 'link' },
                { icon: 'i-Love-User', name: 'Créer un contact', state: '/dashboard/v4', type: 'link' },
            ]
        },
        {
            name: 'OUTILS',
            ...
            icon: 'i-Library',
            sub: [
                { icon: 'i-Files', name: 'Mes documents', state: '/dashboard/v1', type: 'link' },
                { icon: 'i-Money-2', name: 'Mes factures', state: '/dashboard/v2', type: 'link' },
                { icon: 'i-Over-Time', name: 'Mes réalisations', state: '/dashboard/v3', type: 'link' },
                { icon: 'i-Calculator-2', name: 'Calculette surface pondérée', state: '/dashboard/v4', type: 'link' },
                { icon: 'i-Calculator-2', name: 'Calculette valeur locative', state: '/dashboard/v3', type: 'link' },
                { icon: 'i-Calculator-2', name: 'Calculette valeur de droit au bail', state: '/dashboard/v4', type: 'link' },
                { icon: 'i-Search-on-Cloud', name: 'Rechercher un contact', state: '/dashboard/v4', type: 'link' },
                { icon: 'i-Data-Search', name: 'Recherche Explore', state: '/dashboard/v4', type: 'link' },
            ]
        },
